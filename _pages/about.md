...
- <span style="display: inline-flex; align-items: center; justify-content: center; width: 160px; height: 75px; vertical-align: middle; margin-right: 10px;"><img src="../images/NEX.svg" alt="NEX-AGI" style="max-width: 160px; max-height: 50px;"></span><span style="display: inline-block; vertical-align: middle;"><span class="lang-en">**2025.3 - Present** · Algorithm Researcher, **NEX-AGI** (Shanghai Qiji Zhifeng Co., Ltd.), Shanghai</span><span class="lang-zh">**2025.3 - 至今** · 算法研究员，**NEX-AGI**（上海稷跃智锋），上海</span></span><br><span class="lang-en">*Self-evolving agents & reinforcement learning for coding and search agents*</span><span class="lang-zh">*面向代码与搜索智能体的自演化智能体与强化学习*</span>
